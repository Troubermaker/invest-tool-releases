...
// 普通用户没法触发扫描，候选池对他们永远是空的，没必要暴露入口
const ALL_NAV_ITEMS = [
  ...
  // 候选池：扫描器选中后用户主动 ⭐ 收藏的票，持续追踪买点（管理员专属）
  { id: 'candidates', name: '候选', adminOnly: true, icon: 'M3 3v18m0-15h13.5l-3 4.5 3 4.5H3' },
  // 量化选股：全市场扫描发现工具集合（近期发车 / 龙回头 / 连板游资）（管理员专属）
  { id: 'quant', name: '选股', adminOnly: true, icon: 'M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 7.5v5.25m3-3v3' },
