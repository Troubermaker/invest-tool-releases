...
这是一个基于 Python (PyWebview) 和 Vue 3 开发的桌面端量化投研分析工具。支持 A 股核心指数实时行情、热门板块分析、量化选股扫描器，以及 AI 驱动的盘面解读。

> 📖 **应用使用文档**：[USAGE.md](./USAGE.md)（量化选股 / 候选池追踪 / 数据缓存 等功能详解）
> 本 README 主要是开发环境搭建与项目结构说明。
